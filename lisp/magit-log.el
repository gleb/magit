...
(defun magit-log-goto-same-commit ()
  (when (and magit-previous-section (derived-mode-p 'magit-log-mode))
    (-when-let*
        ((value   (magit-section-value magit-previous-section))
         (section (--first (equal (magit-section-value it) value)
